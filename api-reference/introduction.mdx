...
- [aiConnected Platform overview](/knowledge-base/aiconnected-business-platform/aiconnected-platform-overview)
- [aiConnected Platform foundation PRD](/knowledge-base/aiconnected-business-platform/aiconnected-platform-foundation-prd)
- [aiConnected Platform MVP specification](/knowledge-base/aiconnected-business-platform/aiconnected-platform-v1-mvp-specification)
- [aiConnected Platform v2 port map](/knowledge-base/aiconnected-business-platform/aiconnected-platform-v2-port-map)
- [What is the platform shell](/knowledge-base/aiconnected-business-platform/what-is-the-platform-shell)
- [aiConnectedOS developer documentation](/knowledge-base/aiconnected-os/aiconnected-os-developer-documentation)
