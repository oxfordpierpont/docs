...
- [Manifest contracts](/api-reference/sdk/manifest-contracts)
- [Schemas](/api-reference/sdk/schemas)
- [Client and CLI](/api-reference/sdk/client-cli)
- [Platform app APIs](/api-reference/sdk/platform-app-apis)
- [Capabilities APIs](/api-reference/sdk/capabilities-apis)
...
Use the platform-side admin import API documented in [Platform app APIs](/api-reference/sdk/platform-app-apis).
