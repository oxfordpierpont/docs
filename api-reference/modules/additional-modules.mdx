...
- [aiConnected modules overview](/knowledge-base/aiconnected-apps-and-modules/modules/aiconnected-modules-overview)
- [KB Generator readme](/knowledge-base/aiconnected-apps-and-modules/modules/kb-generator/kb-generator-readme)
- [KB Generator field reference](/knowledge-base/aiconnected-apps-and-modules/modules/kb-generator/kb-generator-field-reference)
- [KB Generator design and build instructions](/knowledge-base/aiconnected-apps-and-modules/modules/kb-generator/kb-generator-design-build-instructions)
- [aiConnected webinar](/knowledge-base/aiconnected-apps-and-modules/modules/aiconnected-webinar)
- [legacy funnelChat overview](/knowledge-base/aiconnected-apps-and-modules/modules/funnelChat/legacy-funnelChat-overview)
- [legacy funnelChat PRD](/knowledge-base/aiconnected-apps-and-modules/modules/funnelChat/legacy-funnelChat-prd)
